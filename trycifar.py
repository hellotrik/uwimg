...
m = conv_net()
print("training...")
train_image_classifier(m, train, batch, iters//3, rate, momentum, decay)
train_image_classifier(m, train, batch, iters//3, rate*0.1, momentum, decay)
train_image_classifier(m, train, batch, iters//3, rate*0.01, momentum, decay)
print("done")
print
